	...
	<ul class="flex gap-4">
		<li class="cursor-pointer ">
			<svg
				...
				height="16"
				fill="currentColor"
				class="bi bi-linkedin hover:text-light hover:shadow-lg hover:shadow-light"
				viewBox="0 0 16 16"
			>
				<path
		...
		<li class="cursor-pointer ">
			<svg
				...
				height="16"
				fill="currentColor"
				class="bi bi-twitter hover:text-light hover:shadow-lg hover:shadow-light"
				viewBox="0 0 16 16"
			>
				<path
		...
		<li class="cursor-pointer ">
			<svg
				...
				height="16"
				fill="currentColor"
				class="bi bi-github hover:text-light hover:shadow-lg hover:shadow-light"
				viewBox="0 0 16 16"
			>
				<path
